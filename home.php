...
<body>
    ...
    <div class="contentss">
        <div class="welcome-message">
            ...
            <button onclick="location.href='booking.php'" class="book-now">BOOK NOW <span><br>EXCLUSIVE OFFERS</span></button>
...
<div class="containeer">
  ...
  <br>
    ...
    <hr style="margin-left: 1%; width: 110%;">
